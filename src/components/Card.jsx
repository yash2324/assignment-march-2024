...
const Card = () => {
  ...
  return (
    <div className="flex justify-center font-display">
      <div className="relative -top-24 bg-cyan-white flex flex-col items-center w-10/12 py-8 rounded-2xl shadow-2xl md:w-7/12 lg:w-[40%]">
        <div className="w-full px-4 md:flex md:justify-between md:flex-wrap md:px-9 md:items-center">
          <div className="text-bluish-grayish tracking-widest mb-12 text-center md:mb-0">
            {pageview} PAGEVIEWS
          </div>
        ...
        <div className=" relative flex justify-center items-center w-full mb-10 pl-12 gap-2 sm:gap-6 ">
          <div className="text-sm text-bluish-grayish">Monthly Billing</div>
        ...
        <hr className="border border-bluish-lightGrayish  w-full" />
        ...
        <div className="flex flex-col font-semibold items-center mt-6 md:flex-row md:justify-between md:w-full md:px-9">
          <div className="flex flex-col items-center md:items-start">
            <div className="flex items-center gap-2 mb-2">
              ...
              <div className="text-bluish-grayish text-md">
                Unlimited Websites
              </div>
            </div>
            <div className="flex items-center gap-2 mb-2">
